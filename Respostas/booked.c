...
void aceitarRecomendacao(bookED *alexandria, int id3, int id2, int id1) {
  Leitor *leitor2 =
      (Leitor *)buscaDadoNaLista(alexandria->leitores, id3, getIdLeitor);
  int id = 1000000 * id1 + 1000 * id2 + id3;
  Recomendacao *recomendacao = getRecomendacaoId(leitor2, id);
  imprimeRecomendacaoAceita(recomendacao, 1, alexandria->fSaida);
}

void rejeitarRecomendacao(bookED *alexandria, int id3, int id2, int id1) {
  Leitor *leitor2 =
      (Leitor *)buscaDadoNaLista(alexandria->leitores, id3, getIdLeitor);
  int id = 1000000 * id1 + 1000 * id2 + id3;
  Recomendacao *recomendacao = getRecomendacaoId(leitor2, id);
  imprimeRecomendacaoAceita(recomendacao, 0, alexandria->fSaida);
}
...
void executabookED(bookED *alexandria) {
  ...
  do {
    ...
    if (comando == 1) {
      ...
      aceitarRecomendacao(alexandria, id1, id2, id3);
    } else if (comando == 5) {
