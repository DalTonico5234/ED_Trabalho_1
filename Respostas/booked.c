...
{
    Leitor *leitor1 = (Leitor *)buscaDadoNaLista(alexandria->leitores, id1, getIdLeitor);
    Leitor *leitor2 = (Leitor *)buscaDadoNaLista(alexandria->leitores, id2, getIdLeitor);
...
void buscaAfinidade(bookED *alexandria, int id1, int id2)
{
    Leitor *leitor1 = (Leitor *)buscaDadoNaLista(alexandria->leitores, id1, getIdLeitor);
    Leitor *leitor2 = (Leitor *)buscaDadoNaLista(alexandria->leitores, id2, getIdLeitor);
...
void executabookED(bookED *alexandria)
{
    ...
    do
    {
        ...
        {
            buscaAfinidade(alexandria, id1, id3);
        }
        else if (comando == 8)
        {
